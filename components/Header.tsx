export const Header = () => {
  return (
    <header className="flex bg-primary text-secondary  px-2 py-4 border-b border-secondary">
      <div className="flex items-center w-full max-w-10xl mx-auto justify-between read-width">
        ...
        <nav>
          <ul className="flex item-center gap-4">
            ...
            <li>
              <a
                download
                href="CV/CV-prof Pedro Reis Lima.pdf"
                ...
                <svg
                  ...
                  fill="currentColor"
                  viewBox="0 0 16 16"
                  className="my-auto mx-auto w-4 h-4 group-has-hover:text-accent">
